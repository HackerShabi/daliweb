...
const QuoteForm = ({ onSuccess, className = '' }: QuoteFormProps) => {
    ...
    <div className={`bg-white rounded-xl shadow-lg p-8 ${className}`}>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div>
            <label htmlFor="quote-businessType" className="block text-sm font-medium text-gray-700 mb-2">
              Business Type *
            </label>
            <select
              id="quote-businessType"
        ...
        <div>
          ...
          <textarea
            ...
            {...register('message')}
            className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-green focus:border-primary-green transition-colors text-gray-900 bg-white"
            placeholder="Describe what kind of website you need, your goals, timeline, budget range, etc."
          />
          {errors.message && (
